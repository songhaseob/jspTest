...
public class UserVo {
	...
	/*
	 * public String getReg_dt_fmt() { // reg_dt 필드가 null 이면 "" 문자열 반환 // reg_dt 필드가
	 * null이 아니면 SimpleDateFormat을 // 생성하여 yyyy.mm.dd 포맷의 문자열로 변환하여 리턴
	 * if(this.reg_dt == null) { return ""; }else { SimpleDateFormat sdf = new
	 * SimpleDateFormat("yyyy.MM.dd"); return sdf.format(this.reg_dt);
	 * 
	 * //return new SimpleDate Format("yyyy.MM.dd").fomat(this.reg_dt) } }
	 */
